...
const EXTERNAL_MODELS: ExternalModel[] = [
  ...
  // --- Flagship / Latest (sorted by modified_at descending) ---
  { id: 'deepseek-v4-pro:0813', name: 'DeepSeek V4 Pro', provider: 'ollama-cloud', description: '892B — latest DeepSeek flagship (Aug 2026)' },
  { id: 'glm-5.3', name: 'GLM 5.3', provider: 'ollama-cloud', description: '755B — latest GLM with thinking + tools (Aug 2026)' },
  { id: 'glm-5.3-flash', name: 'GLM 5.3 Flash', provider: 'ollama-cloud', description: '328B — fast GLM with vision + thinking (Aug 2026)' },
  { id: 'deepseek-v4-flash:0731', name: 'DeepSeek V4 Flash', provider: 'ollama-cloud', description: '167B — fast DeepSeek V4 (Jul 2026)' },
  { id: 'kimi-k3', name: 'Kimi K3', provider: 'ollama-cloud', description: '1.5T — Moonshot flagship (Jul 2026)' },
  { id: 'nemotron-3-ultra', name: 'Nemotron 3 Ultra', provider: 'ollama-cloud', description: 'NVIDIA largest Nemotron (Jun 2026)' },
  { id: 'kimi-k2.7-code', name: 'Kimi K2.7 Code', provider: 'ollama-cloud', description: '595B — code specialist (Jun 2026)' },
  { id: 'minimax-m3', name: 'MiniMax M3', provider: 'ollama-cloud', description: 'Latest MiniMax model (Jun 2026)' },
  { id: 'glm-5.2', name: 'GLM 5.2', provider: 'ollama-cloud', description: '756B — GLM thinking model (Jun 2026)' },
  { id: 'kimi-k2.6', name: 'Kimi K2.6', provider: 'ollama-cloud', description: '595B — improved Kimi (Apr 2026)' },
  { id: 'glm-5.1', name: 'GLM 5.1', provider: 'ollama-cloud', description: '1.5T — massive GLM model (Apr 2026)' },
  ...
  { id: 'nemotron-3-super', name: 'Nemotron 3 Super', provider: 'ollama-cloud', description: '230B — NVIDIA mid-tier (Mar 2026)' },
  ...
  { id: 'gemma4:31b', name: 'Gemma 4 31B', provider: 'ollama-cloud', description: '31B Gemma 4 (Apr 2026)' },
