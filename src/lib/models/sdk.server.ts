...
const EXTERNAL_MODELS: ExternalModel[] = [
  // Ollama Cloud models (require OLLAMA_API_KEY)
  {
    ...
    description: 'Massive 397B model on Ollama Cloud',
  },
  {
    id: 'qwen3-coder-next',
  ...
  },
  {
    ...
    name: 'Kimi K2.5',
    provider: 'ollama-cloud',
    description: '1.1T parameter model',
  },
  {
    id: 'kimi-k2-thinking',
  ...
  },
  {
    ...
    name: 'Cogito 2.1',
    provider: 'ollama-cloud',
    description: '671B thinking model',
  },
  {
    id: 'minimax-m2.5',
    name: 'MiniMax M2.5',
  ...
  },
  {
    ...
    provider: 'ollama-cloud',
    description: '675B Mistral',
  },
  {
    id: 'devstral-small-2:24b',
    name: 'Devstral Small 2',
    provider: 'ollama-cloud',
    description: '24B code agent',
  },
