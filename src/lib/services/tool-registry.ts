...
class ToolRegistry {
  ...
  private registerBuiltInTools(): void {
    ...
    // ==================== SAM.gov OPPORTUNITY TRACKING (DEPRECATED) ====================
    // These tools are disabled. They will be re-enabled in the proposal manager module.
    // The SAM.gov API returns 410 Gone - see /future/proposal-manager/sam_api
